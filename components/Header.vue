<template>
  <div class="header-container fixed border-b border-b-white">
    <div class="header mx-auto h-24 flex items-center justify-between px-8 py-6 w-full">
      ...
      <ul class="items-center hidden xl:flex header-nav">
        ...
        <li class="ml-10">
          <a href="tel:330184257027" class="button-orange text-link">01 84 25 70 27</a>
        </li>
      </ul>
      ...
      <ul class="items-center hidden header-nav" :class="{ active: isActive }">
        ...
        <li class="ml-10">
          <a @click="isActive = !isActive" href="tel:330184257027" class="button-orange text-link">01 84 25 70 27</a>
        </li>
      </ul>
